import { Link, useActionData, json, redirect } from "remix"
      ...
      <div className="login-form">
        <div className="mask">
          <form method="post" target="_self">
            <input type="text" name="username" id="" placeholder="Username" defaultValue={actionData?.fields?.username}/>
            <div className="error">
              <p>{actionData?.fieldErrors?.username && (actionData?.fieldErrors?.username)}</p>
            </div>
            <input type="password" name="password" id="" placeholder="Password" defaultValue={actionData?.fields?.password} />
            <div className="error">
