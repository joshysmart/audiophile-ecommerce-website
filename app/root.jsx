  ...
  return [
    {
      name: "description",
      content:
        "An audiophile e-commerce site built with remix for those who love sound",
    },
    {
      name: "keywords",
...
export default function App() {
  ...
  return (
    <Document title="Audiophile E-commerce Website">
      <Layout user={user} products={products}>
        <Outlet />
      </Layout>
    </Document>
  );
  ...
  return (
    <html lang="en">
      <head>
        ...
        <title>{title ? title : "Audiophile E-commerce Website"}</title>
        <Meta />
        <Links />
      </head>
      <body>
      ...
      <div className="quantity">
        <div className="text">
          <label htmlFor={`quantity-${index}`}>
            <span className="operator minus" data-clicked="minus">
              -
            </span>
            <input
              type="number"
              ...
              autoComplete="off"
            />
            <span className="operator plus" data-clicked="plus">
              +
            </span>
          </label>
        </div>
      ...
      <header className="header">
        <nav className="navbar">
          ...
          <ul className="nav" ref={navEl}>
            ...
            <li>
              <Link to="/category/headphones" target={"_self"}>
                Headphones
              </Link>
            </li>
            <li>
              <Link to="/category/speakers" target={"_self"}>
                Speakers
              </Link>
            </li>
            <li>
              <Link to="/category/earphones" target={"_self"}>
                Earphones
              </Link>
            </li>
                ...
                {user ? (
                  <form action="/auth/logout" method="post" target="_self">
                    <button type="submit" className="logout">
                      <i className="fas fa-user-alt" aria-hidden>
